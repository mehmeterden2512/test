...
public class C06_SifreKontrolu {
    public static void main(String[] args) {
        ...
        //- sifre kontrolunu bir methodda yapip true/false dondurun
        ...
        while (tekrarSifreIste){
            ...
            sifre=scan.nextLine();
            sifreKontrolET(sifre);
            if (sifreKontrolET(sifre)){//sifre kontrolu true donerse sifre basarali demektir
