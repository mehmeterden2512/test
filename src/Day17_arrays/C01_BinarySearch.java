...
public class C01_BinarySearch {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.binarySearch(arr,5));//-5 hem yok diyor hem olsaydi burda olurdu diyor

        System.out.println(Arrays.binarySearch(arr,18));//-8
        /*
        olmayan bir elementi binarySearch ile aratirsaniz once listede olsaydi
        kacinci sirada olurdu cevabini verir olmadigini belirtemek icin basina eksi(-) koyar
