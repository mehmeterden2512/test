...
public class C06_TreeMapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(harfSayilariMap.subMap("B","K"));//{C=15, D=3} B den sonra ne varsa geldi

        System.out.println(harfSayilariMap.descendingMap());//{K=5, D=3, C=15, A=10} tersten yazdirdi

        System.out.println(harfSayilariMap.lowerKey("E"));//D E den daha az olacak
        ...
        System.out.println(harfSayilariMap.higherKey("D"));//K den buyuk olanı verir
        ...
        System.out.println(harfSayilariMap.pollFirstEntry());//A=10 getirdiğini siler
