...
public class C04_Deque {
    public static void main(String[] args) {
        ...
        //Deque double ended queue demketir
        //iki yonlu kuyruk
        //bu iki yonlu yapısında dolayı pek cok method'un firs(); ve last(); versiyonu vardır.
        ...
        System.out.println(kopyaKarakterler);//[B, A] kopyalıyor ve atıyor cast yaptık
    }
}
